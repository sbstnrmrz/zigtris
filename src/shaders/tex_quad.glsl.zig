...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/tex_quad.glsl -o src/shaders/tex_quad.glsl.zig -l metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
